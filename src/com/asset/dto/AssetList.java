...
public class AssetList extends BaseEntity{
	...
	private String backupAdminName;
	...
	public void setBackupAdminName(String backupAdminName) {
		this.backupAdminName = backupAdminName;
	}
	public String getBackupAdminName() {
		return backupAdminName;
	}
